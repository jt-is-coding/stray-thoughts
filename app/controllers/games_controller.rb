class GamesController < ApplicationController
  ...
  def search
    ...
    giant_bomb_url1 = "https://www.giantbomb.com/api/games/?api_key=#{ENV.fetch("GIANT_BOMB_KEY")}&format=json&field_list=name,deck,image,platforms&filter=expected_release_year:#{user_year}"
    ...
    if max_number > 100
      giant_bomb_url2 = "https://www.giantbomb.com/api/games/?api_key=#{ENV.fetch("GIANT_BOMB_KEY")}&format=json&field_list=name,deck,image,platforms&offset=#{rand(100..max_offset)}&filter=expected_release_year:#{user_year}"
